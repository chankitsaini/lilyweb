    ...
    79: function (t, e, i) {
        ...
        function S(t, e, i) {
            ...
            var r = t.x - e.x,
                o = t.y - e.y;
            function n(t, e) {
                return (180 * Math.acos(((i = { x: 0, y: 1 }), (o = t), (n = e), (s = Math.sqrt(o * o + n * n)), (r = { x: o / s, y: n / s }), i.x * r.x + i.y * r.y))) / Math.PI;
                var i, r, o, n, s;
            }
            var s = n(r, o);
            e.x < t.x && (s = 360 - s);
        ...
        function x(t) {
            ...
            "touchstart" == t.type
                ...
                ? ((e = h),
                  ...
                  (o = D(e.clientY - i.top)),
                  (s = S({ x: i.left + i.width / 2, y: i.top + i.height * v }, { x: e.clientX, y: e.clientY }, i)),
                  (a = A(s.x - i.left)),
                  (_ = w(s.y - i.top)),
        ...
        (function (t) {
                        ...
                        if (1 == t.length) {
                            ...
                            for (u = 0; u < t.length; u++) {
                                ...
                                if (o == u) s.setPartsOpacity(c, n);
                                    ...
                                    var l,
                                        $ = s.getPartsOpacity(c);
                                    (1 - (l = n < 0.5 ? (-0.5 * n) / 0.5 + 1 : (0.5 * (1 - n)) / 0.5)) * (1 - n) > 0.15 && (l = 1 - 0.15 / (1 - n)), $ > l && ($ = l), s.setPartsOpacity(c, $);
                                }
                            }
                        }
                    else
                ...
                (o.prototype.setupClip = function (t, e) {
                    ...
                    if (i > 0) {
                        ...
                        for (r = 0; r < this.clipContextList.length; r++) {
                            ...
                            this.tmpBoundsOnModel._$jL(a), this.tmpBoundsOnModel.expand(0.05 * a.width, 0.05 * a.height);
                ...
                (o.prototype.setupLayoutBounds = function (t) {
                    ...
                    for (var r = 0, n = 0; n < o.CHANNEL_COUNT; n++) {
                        ...
                        if (0 == s);
                            ...
                            for (var _ = 0; _ < s; _++) {
                                var h = 0;
                                (l = ~~(l = _ % 2)), (($ = this.clipContextList[r++]).layoutChannelNo = n), ($.layoutBounds.x = 0.5 * l), ($.layoutBounds.y = 0), ($.layoutBounds.width = 0.5), ($.layoutBounds.height = 1);
                            }
                        else if (s <= 4)
                            for (_ = 0; _ < s; _++) {
                                (l = ~~(l = _ % 2)),
            ...
            (T._$ni = function (t, e, i, r, o, n, s, a, _) {
                ...
                (v._$Z2 = function (t, e, i, r) {
                    ...
                    if (4 == o) {
                        ...
                        return (
                            ((v = ((a = ((p = (S + (L - S) * $) | 0) + ((c = (E + (M - E) * $) | 0) - p) * u) | 0) + ((_ = ((f = (x + (A - x) * $) | 0) + ((g = (w + (I - w) * $) | 0) - f) * u) | 0) - a) * P) | 0) +
                                ((((h = ((y = (D + (O - D) * $) | 0) + ((d = (b + (R - b) * $) | 0) - y) * u) | 0) + ((l = ((m = (F + (C - F) * $) | 0) + ((T = (N + (B - N) * $) | 0) - m) * u) | 0) - h) * P) | 0) - v) * G) |
                            0
                        );
                    }
                ...
                (v._$br = function (t, e, i, r) {
                    ...
                    if (4 == o) {
                        var P = r[n[0]],
                            ...
                            B = s[3];
                        return (
                            (1 - B) * ((1 - N) * ((1 - T) * (P + (v - P) * $) + T * (S + (L - S) * $)) + N * ((1 - T) * (E + (M - E) * $) + T * (x + (A - x) * $))) +
                            B * ((1 - N) * ((1 - T) * (w + (I - w) * $) + T * (D + (O - D) * $)) + N * ((1 - T) * (b + (R - b) * $) + T * (F + (C - F) * $)))
                        );
                    }
                    ...
                    if (_ <= 0) {
                        ...
                        for (c = 0; c < $; )
                            (n[u] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + vt * rt[c] + St * ot[c] + Lt * nt[c]),
                                ++c,
                                (n[u + 1] =
                                    ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + vt * rt[c] + St * ot[c] + Lt * nt[c]),
                                ++c,
                                (u += a);
                    } else {
            ...
            (V.STATE_FIRST = "STATE_FIRST"),
                    ...
                    if ((i._$hS(!0), this._$32())) {
                        ...
                        if ((i._$8r == x._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0)) at._$so && a._$li("_$L _$0P _$G :: %s", r), i._$hS(!1);
                            ...
                            if (null != o) {
                                ...
                                var _ = z._$io;
                                (_[0] = 0), (_[1] = -0.1), n._$GT().getType() == x._$c2 ? (_[1] = -10) : (_[1] = -0.1);
                                var h = z._$0o;
                ...
                (q._$er = function (t) {
                    ...
                    for (
                        var i = ["../_$_r/_$t0/_$Ri/_$_P.512/_$CP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$vP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$EP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$pP._$1"], r = q.loadModel(e._$3b()), o = 0;
                        o < i.length;
                        o++
                    ) {
                        var n = new _$5(i[o]);
                                    ...
                                    if ((97 <= s && s <= 122) || (65 <= s && s <= 90) || "_" == n) {
                                        ...
                                        if (u >= 0) {
                                            ...
                                            I.startsWith(t, $, J._$cs)
                                                ? ((a._$RP = N._$hs), (a._$4P = I.createString(t, $, u - $)))
                                                ...
                                                : ((a._$RP = N._$Fr), (a._$4P = I.createString(t, $, u - $))),
                                                e.motions.push(a);
                                            var _ = 0,
                                                h = [];
                                            for (o = u + 1; o < r && "\r" != (n = Q(t, o)) && "\n" != n; ++o)
                ...
                (Z.transformPoints_sdk2 = function (e, i, r, o, n, s, a, _) {
                    for (var h, l, $, u = r * n, p = 0, c = 0, f = 0, g = 0, y = 0, d = 0, m = !1, T = o; T < u; T += n) {
                        ...
                        if (((S = e[T]), (v = (L = e[T + 1]) * _), (P = S * a) < 0 || v < 0 || a <= P || _ <= v)) {
                            ...
                            if (!m) {
                                (m = !0),
                                    (p = 0.25 * (s[2 * (0 + 0 * E)] + s[2 * (a + 0 * E)] + s[2 * (0 + _ * E)] + s[2 * (a + _ * E)])),
                                    (c = 0.25 * (s[2 * (0 + 0 * E) + 1] + s[2 * (a + 0 * E) + 1] + s[2 * (0 + _ * E) + 1] + s[2 * (a + _ * E) + 1]));
                                var M = s[2 * (a + _ * E)] - s[2 * (0 + 0 * E)],
                                    x = s[2 * (a + _ * E) + 1] - s[2 * (0 + 0 * E) + 1],
                                    A = s[2 * (a + 0 * E)] - s[2 * (0 + _ * E)],
                                    w = s[2 * (a + 0 * E) + 1] - s[2 * (0 + _ * E) + 1];
                                (p -= 0.5 * ((f = 0.5 * (M + A)) + (y = 0.5 * (M - A)))), (c -= 0.5 * ((g = 0.5 * (x + w)) + (d = 0.5 * (x - w))));
                            }
                            if (-2 < S && S < 3 && -2 < L && L < 3)
                                if (S <= 0)
                                    if (L <= 0) {
                                        ...
                                        (B = 0.5 * (S - -2)) + (G = 0.5 * (L - -2)) <= 1
                                            ? ((i[T] = C + (R - C) * B + (O - C) * G), (i[T + 1] = N + (F - N) * B + (b - N) * G))
                                            : ((i[T] = I + (O - I) * (1 - B) + (R - I) * (1 - G)), (i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G)));
                                    } else if (L >= 1) {
                            ...
                            (h = 2 * ((0 | P) + (0 | v) * (a + 1))),
                                (l = P - (0 | P)) + ($ = v - (0 | v)) < 1
                                    ? ((i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (a + 1)] * $), (i[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (a + 1) + 1] * $))
                                    : ((i[T] = s[h + 2 * (a + 1) + 2] * (l - 1 + $) + s[h + 2 * (a + 1)] * (1 - l) + s[h + 2] * (1 - $)),
                    ...
                    for (var a, _, h, l, $, u, p, c = e, f = this._$o, g = this._$A, y = o * s, d = null != c._$hr ? c._$hr : c._$Cr, m = n; m < y; m += s)
                        at._$ts
                            ? ((a = i[m]),
                              ...
                              (p = _ - l),
                              ($ = 2 * (h + l * (f + 1))))
                            : ((u = (a = i[m] * f) - (0 | a)), (p = (_ = i[m + 1] * g) - (0 | _)), ($ = 2 * ((0 | a) + (0 | _) * (f + 1)))),
                            u + p < 1
                                ? ((r[m] = d[$] * (1 - u - p) + d[$ + 2] * u + d[$ + 2 * (f + 1)] * p), (r[m + 1] = d[$ + 1] * (1 - u - p) + d[$ + 3] * u + d[$ + 2 * (f + 1) + 1] * p))
                                : ((r[m] = d[$ + 2 * (f + 1) + 2] * (u - 1 + p) + d[$ + 2 * (f + 1)] * (1 - u) + d[$ + 2] * (1 - p)),
                ...
                (ot.clip = function (t, e, i, r, o, n, s, a, _, h, l, $, u, p, c, f) {
                    i > 0.02 ? ot.expandClip(t, e, i, r, l, $, u, p, c, f) : ot.clipWithTransform(t, null, o, n, s, a, _, h);
                }),
                ...
                (pt._$er = function (t) {
                    ...
                    if (0 == e.exists()) throw new _$ls("_$t0 _$_ _$6 _$Ui :: " + e._$PL());
                    for (
                        var i = ["../_$_r/_$t0/_$Ri/_$_P.512/_$CP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$vP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$EP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$pP._$1"], r = pt.loadModel(e._$3b()), o = 0;
                        o < i.length;
                        o++
                    ) {
                        var n = new _$5(i[o]);
            ...
            (o.prototype.loadModelData = function (t, e) {
                ...
                i.loadLive2DModel(t, function (t) {
                    (o.live2DModel = t),
                        ...
                        0 == r.Live2D.getError()
                            ? ((o.modelMatrix = new $(o.live2DModel.getCanvasWidth(), o.live2DModel.getCanvasHeight())), o.modelMatrix.setWidth(2), o.modelMatrix.setCenterPosition(0, 0), e(o.live2DModel))
                ...
                for (n = 0; n < e.length; n++) {
                    if (!((s = e[n].partsIndex) < 0))
                        if (r == n) t.setPartsOpacity(s, o);
                            ...
                            (1 - (_ = o < 0.5 ? (-0.5 * o) / 0.5 + 1 : (0.5 * (1 - o)) / 0.5)) * (1 - o) > 0.15 && (_ = 1 - 0.15 / (1 - o)), h > _ && (h = _), t.setPartsOpacity(s, h);
                        }
                }
            }),
    ...
    85: function (t, e, i) {
        ...
        t.exports = {
            createDialogElement: function (t) {
                if (
                    ((($ = document.createElement("div")).className = "live2d-widget-dialog-container"),
                ...
                return function (e, i) {
                    ...
                    var n = (function (t) {
                        var e = /^(\d+)(s|seconds?)$/g,
                            ...
                            n = 0;
                        return (
                            e.test(o) ? ((e.lastIndex = 0), (n = 1e3 * parseInt(e.exec(o)[1]))) : i.test(o) ? ((i.lastIndex = 0), (n = parseInt(i.exec(o)[1]))) : r.test(o) && ((r.lastIndex = 0), (n = 60 * parseInt(r.exec(o)[1]) * 1e3)), n
                        );
                    })(r);
                    if (n) {
                        var s = null,
        ...
        t.exports = {
            hitokotoVariable: function () {
                return new Promise(function (t) {
                    fetch('./assets/msg.json')
                        .then(response => response.json())
                        .then(data => {
                            // Get a random index from the array
                            const randomIndex = Math.floor(Math.random() * data.length);
                            t(data[randomIndex].hitokoto); // Return the random hitokoto
                        })
                        .catch(error => {
            ...
            (a.prototype.tapEvent = function (t, e) {
                ...
                for (var i = 0; i < this.models.length; i++)
                    this.models[i].hitTest(s.cDefine.HIT_AREA_HEAD, t, e)
                        ? (this.eventemitter.emit("tapface"), s.cDefine.DEBUG_LOG && console.log("Tap face."), this.models[i].setRandomExpression())
                        : this.models[i].hitTest(s.cDefine.HIT_AREA_BODY, t, e) &&
                          (this.eventemitter.emit("tapbody"), s.cDefine.DEBUG_LOG && console.log("Tap body. models[" + i + "]"), this.models[i].startRandomMotion(s.cDefine.MOTION_GROUP_TAP_BODY, s.cDefine.PRIORITY_NORMAL));
                return !0;
            }),
            (e.cManager = a);
    },
